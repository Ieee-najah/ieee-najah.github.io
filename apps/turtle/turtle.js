...
Turtle.LOADED_BLOCKS = '<xml>'+BlocklyApps.getStringParamFromUrl("blocks", "")+'</xml>';

// main website
Turtle.WEBSITE = "http://localhost/thinklikeprogrammer/";

Turtle.TOOLBOX_TYPE = "full"; // TODO specify later
Turtle.MAX_BLOCKS = Infinity; // TODO specify later
...
//   });
  ...
  var defaultXml = Turtle.LOADED_BLOCKS || '<xml></xml>'; // edited by Zuhair
